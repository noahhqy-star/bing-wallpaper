              ...
              <div className={`img-info ${(!showBottom || (isMobile && !infoExpanded)) ? 'collapsed' : ''}`}>
                {isMobile && (
                  <button
                    ...
                    type="button"
                  >
                    <svg className={!infoExpanded ? 'collapsed' : ''} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
